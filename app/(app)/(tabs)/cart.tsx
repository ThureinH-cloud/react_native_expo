...
import { FlatList,Alert,SafeAreaView, Text,Pressable,StyleSheet,View } from 'react-native'
...
const CartItem=({
  ...
  dispatch,
  onRemove
}:{id:number,title:string,price:number,image:any,items:any[],dispatch:any,onRemove:(id:number,itemId:number,title:string)=>void})=>{
    ...
    return (
      <SafeAreaView style={{flex:1,justifyContent: "center",alignItems: "center",backgroundColor:"white"}}>
          <LottieView
            ...
            source={require("@/assets/images/Animation - 1725723829436.json")}
          />
        <Text>You don't have cart</Text>
      </SafeAreaView>
    )
  }
